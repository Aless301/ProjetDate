...
<div class="bubbleG">
    <div class="arrow left-arrow"></div>
    <p>Tu es très proche de ta famille ?</p>
</div>
...
<div class="bubbleQ">
    <form action="q1.php" method="post">
        ...
        <label for="reponse1">
            <p>"J'aime le rock country et le rap indien." ?</p>
        </label><br>

        <input type="radio" id="r11" name="r11" value="11">
        <label for="reponse2">
            <p>"J'aime les musiques de soirées." ?</p>
        </label><br>

        <input type="radio" id="r12" name="r12" value="12">
        <label for="reponse3">
            <p>"Oui, j'aime le jazz." ?</p>
        </label><br>
...
<div class="bubbleG">
    <div class="arrow left-arrow"></div>
    <p>C'est quoi ton style vestimentaire ?</p>
</div>
...
<div class="bubbleQ">
    <form action="q1.php" method="post">
        ...
        <label for="reponse1">
            <p>"Je m'habille en old money." ?</p>
        </label><br>

        <input type="radio" id="r33" name="r33" value="33">
        <label for="reponse2">
            <p>"Je suis fashion week du streetwear." ?</p>
        </label><br>

        <input type="radio" id="r34" name="r34" value="34">
        <label for="reponse3">
            <p>"Je m'habille gothique." ?</p>
        </label><br>
...
<div class="bubbleQ">
    <form action="q1.php" method="post">
        ...
        <label for="reponse1">
            <p>"Oui, j'ai fait Top Chef Junior en Franche-Comté." ?</p>
        </label><br>

        <input type="radio" id="r15" name="r15" value="15">
        <label for="reponse2">
            <p>"La place de la femme c'est à la cuisine." ?</p>
        </label><br>

        <input type="radio" id="r16" name="r16" value="16">
        <label for="reponse3">
            <p>"J'ai déjà fait des pâtes." ?</p>
        </label><br>
...
<div class="bubbleG">
    <div class="arrow left-arrow"></div>
    <p>Tu veux du vin avec ton repas ?</p>
</div>
...
<div class="bubbleQ">
    <form action="q1.php" method="post">
        ...
        <label for="reponse1">
            <p>ACTION : regarder un film, tu t'endors sur le côté du canapé et elle se vexe.</p>
        </label><br>
        ...
        <label for="reponse3">
            <p>ACTION : faire un slow avec la musique seulement.</p>
        </label><br>
...
<div class="bubbleG">
    <div class="arrow left-arrow"></div>
    <p>Tu penses que tu peux m'offrir cette robe?</p>
</div>
...
<div class="bubbleQ">
    <form action="q1.php" method="post">
        ...
        <label for="reponse1">
            <p>"Oui, c'est 399€ seulement, aucun problème." ?</p>
        </label><br>

        <input type="radio" id="r24" name="r24" value="24">
        <label for="reponse2">
            <p>"Non, j'économise pour acheter des Nitros à des e-girls sur Discord, désolé." ?</p>
        </label><br>

        <input type="radio" id="r25" name="r25" value="25">
        <label for="reponse3">
            <p>"J'aurais pu, mais la robe est loin d'être suffisamment belle pour toi." ?</p>
        </label><br>
...
<div class="bubbleQ">
    <form action="q1.php" method="post">
        ...
        <label for="reponse1">
            <p>ACTION : lancer un duel de Hip-Hop avec le gars.</p>
        </label><br>

        <input type="radio" id="r27" name="r27" value="27">
        <label for="reponse2">
            <p>ACTION : le laisser draguer Lydia.</p>
        </label><br>

        <input type="radio" id="r28" name="r28" value="28">
        <label for="reponse3">
            <p>ACTION: lui montrer une photo de Théo Massin.</p>
        </label><br>
...
<div class="bubbleQ">
    <form action="q1.php" method="post">
        ...
        <label for="reponse1">
            <p>ACTION : lui dire que c'etait chiant </p>
        </label><br>

        <input type="radio" id="r30" name="r30" value="30">
        <label for="reponse2">
            <p>ACTION : lui faire un bisou sur la joue</p>
        </label><br>

        <input type="radio" id="r31" name="r31" value="31">
        <label for="reponse3">
            <p>ACTION : La pousser dans les ortilles</p>
        </label><br>
...
<div class="bubbleQ">
    <form action="q1.php" method="post">
        ...
        <label for="reponse1">
            <p>ACTION : aller regarder la lune au telescope</p>
        </label><br>

        <input type="radio" id="r39" name="r39" value="39">
        <label for="reponse2">
            <p>ACTION : parler du rayon de braquage des Renault Kangoo</p>
        </label><br>

        <input type="radio" id="r40" name="r40" value="40">
        <label for="reponse3">
            <p>ACTION : regarder un live twitch sur une Applewatch</p>
        </label><br>
